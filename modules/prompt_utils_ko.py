...
def make_user_prompt_ko(user_info: dict, items: list):
    """한국어 사용자 프롬프트 생성"""
    info = f"""
[사용자 정보]
...
def make_budget_parsing_prompt_ko(budget_input: str):
    """한국어 예산 파싱 프롬프트"""
    return f"""
...
def extract_price_range_ko(response_text):
    """한국어 가격 범위 추출"""
